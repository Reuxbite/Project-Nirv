import { o as objectType, h as dateType, i as arrayType, j as stringType, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, a as renderTemplate, k as escape, l as renderUniqueStylesheet, n as renderScriptElement, p as createHeadAndContent, r as renderComponent } from './astro/server_BFUiyRVg.mjs';
import { d as removeBase, i as isRemotePath, V as VALID_INPUT_FORMATS, p as prependForwardSlash } from './consts_CDRqZ4y9.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_6pChtZLP.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_DfIClIoe.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_RLxGgUvR.mjs').then(n => n._);
